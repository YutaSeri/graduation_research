...
class Shelter(models.Model):
    shelter_name = models.CharField(verbose_name='Evacuation_name',max_length=30)
    ...
    class Meta:
        ...
        verbose_name_plural = _("Evacuation")
...
class Account(AbstractBaseUser,PermissionsMixin):
    ...
    username = models.CharField(verbose_name='name',max_length=255,unique=False,blank=False, null=False)
    gender = models.CharField(verbose_name='gender',max_length=128,choices=GENDER_CHOICES, blank=False, null=False)
    age = models.IntegerField(verbose_name='age',validators=[MinValueValidator(0),MaxValueValidator(100)],blank=False, null=False)
...
class p_support_Item(models.Model):
    item_name = models.CharField(verbose_name='item_name',max_length=255)
    quantity = models.IntegerField(verbose_name='quantity')
    created_at = models.DateTimeField(verbose_name='application date',default=timezone.now, editable=False)
    arrival_date = models.DateTimeField(verbose_name='Estimated arrival date',blank=True,null=True)
    updated_at = models.DateTimeField(verbose_name='更新日時',auto_now=True)
    account = models.ForeignKey(Account, on_delete=models.CASCADE,related_name='support_items')

    class Meta:
        db_table = 'p_support_Item'
        verbose_name = "[Rationed Goods ]"
        verbose_name_plural = _("Request for Rationed Goods ")
...
class Other_requests(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("other_requests")
